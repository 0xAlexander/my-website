  ...
  return (
    <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24 flex flex-col lg:gap-4">
      <div className="w-full flex lg:items-center lg:justify-start">
        <Avatar className="w-48 h-auto border-2 border-primary">
          <AvatarImage src="./avatar1.webp" />
          <AvatarFallback className="w-48 h-48 rounded-full border-1 border-primary">
            AM
          </AvatarFallback>
        </Avatar>
      </div>
      <div className="flex flex-col gap-4 lg:pr-24 mt-6 lg:mt-0">
        ...
        <h2 className="text-xl lg:text-start">
          Front-end software engineer and Project leader, with experience on
          Quality excellence.
        </h2>
